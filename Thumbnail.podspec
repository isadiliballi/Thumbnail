#
#  Be sure to run `pod spec lint Thumbnail.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/Thumbnail"
  ...
  spec.source       = { :git => "http://EXAMPLE/Thumbnail.git", :tag => "#{spec.version}" }
